...
-(void)application:(UIApplication *)application performFetchWithCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler{
    ...
    ADNPostViewController *rootController = (ADNPostViewController *)self.window.rootViewController;
    ADNPostTableViewController *tableViewController = (ADNPostTableViewController *)rootController.childViewControllers.lastObject; 
